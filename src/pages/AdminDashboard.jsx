    ...
    <div className="admin-page">
      <header className="admin-header">
        <div>
          <h1>Staff Admin</h1>
          <p className="muted">
            Signed in as {profile.username} — BigHappySmiley staff
          </p>
        </div>
      ...
      <div className="admin-columns">
        <section className="admin-panel">
          ...
          <p className="muted small admin-note">
            Promote a user to staff by setting <code>isStaff: true</code> on their
            <code> users/&#123;uid&#125;</code> doc (Firebase console or the
            <code> make-staff</code> script). It can&apos;t be done from the app, by design.
          </p>
        </section>
